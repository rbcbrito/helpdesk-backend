package com.roberto.helpdesk.resources.exceptions;
...
public class ResourceExceptionHandler { 
	...
	public ResponseEntity<StandardError> dataIntegrityViolationExceptionn(DataIntegrityViolationException ex,
			HttpServletRequest request) { 
